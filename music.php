...
$sth = $dbh->prepare("SELECT * FROM `playMarket` WHERE `type` ='music'");
$sth->execute();
...
$pages = [
    ...
    ['name' => 'Music', 'active' => true, 'url' => '../music.php'],
...
echo $twig->render('template.html.twig',
    ['actionPage'=>'../music.php','home'=>$home, 'pages'=>$pages, 'genres'=>$genres, 'header'=>$header, 'products' => $products,'admin'=>$isAdmin, 'authorize' =>$isAuthorize]);